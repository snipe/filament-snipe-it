...
class ListAccessories extends Component implements HasForms, HasTable
{
    ...
    {
        return AccessoryResource::table($table)->relationship(fn (): BelongsToMany => $this->record->accessories());
    ...
    {
        return view('livewire.list-accessories');
    }
}
