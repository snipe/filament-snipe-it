...
class ListConsumables extends Component implements HasForms, HasTable
{
    ...
    {
        return ConsumableResource::table($table)->relationship(fn (): BelongsToMany => $this->record->consumables());
    ...
    {
        return view('livewire.list-consumables');
    }
}
